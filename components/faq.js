...
const questions = [
    {
        ...
        questions: [
            ...
            {
                question: "会場はどこですか？",
                answer: "会場はイベントにより異なります。connpassのイベントページをご確認ください。"
            },
            {
            ...
            {
                question: "パソコンの貸し出しはありますか？",
                answer: "申し訳ございませんが、現在は貸し出しを行っておりません。"
            },
            {
    ...
    },
    {
        ...
        questions: [
            ...
            },
            {
                ...
                answer: "CoderDojo枚方のメンターになりたい方は、お問い合わせメニューからご連絡ください。"
            },
            {
    ...
    },
    {
        ...
        questions: [
            {
                question: "お問い合わせはどこにすればいいですか？",
                answer: "お問い合わせメニューからメールにて受け付けております"
            },
        ]
    }
]
